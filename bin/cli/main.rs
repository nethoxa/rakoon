...
fn main() {
    ...
    match cli.command {
        ...
        Commands::Spam { sk, rpc, seed, no_al, corpus, tx_count, gas_limit, slot_time } => {
            engine.set_sk(sk.clone());
            engine.set_rpc(rpc.clone());
            ...
            println!("[{}] Running spam with sk: {}, rpc: {}, tx_count: {}, slot_time: {}", "+".bright_green(), sk, rpc, tx_count, slot_time);
        ...
        Commands::Blobs { sk, rpc, seed, no_al, corpus, tx_count, gas_limit, slot_time } => {
            engine.set_sk(sk.clone());
            engine.set_rpc(rpc.clone());
            engine.set_seed(seed);
            engine.set_no_al(no_al);
            ...
            println!("[{}] Running blob spam with sk: {}, rpc: {}, tx_count: {}, slot_time: {}", "+".bright_green(), sk, rpc, tx_count, slot_time);
        ...
        Commands::Pectra { sk, rpc, seed, no_al, corpus, tx_count, gas_limit, slot_time } => {
            engine.set_sk(sk.clone());
            engine.set_rpc(rpc.clone());
            engine.set_seed(seed);
            engine.set_no_al(no_al);
            ...
            println!("[{}] Running pectra spam with sk: {}, rpc: {}, tx_count: {}, slot_time: {}", "+".bright_green(), sk, rpc, tx_count, slot_time);
        ...
        Commands::Create { rpc, count } => {
            ...
            println!("[{}] Creating {} accounts with rpc: {}", "+".bright_green(), count, rpc);
        ...
        Commands::Unstuck { sk, rpc, seed, no_al, corpus, tx_count, gas_limit, slot_time } => {
            engine.set_sk(sk.clone());
            engine.set_rpc(rpc.clone());
            engine.set_seed(seed);
            engine.set_no_al(no_al);
            ...
            println!("[{}] Running unstuck with sk: {}, rpc: {}, tx_count: {}, slot_time: {}", "+".bright_green(), sk, rpc, tx_count, slot_time);
